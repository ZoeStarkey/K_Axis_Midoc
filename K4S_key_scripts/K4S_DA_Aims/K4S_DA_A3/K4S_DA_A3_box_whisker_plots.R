...
plot_Smax <- create_boxplot(km_df_filtered, env_var = "Smax", dep_var = "bm_g_m3")
...
save_plot(plot_Smax, "boxplot_Smax_no_gelat.png")
...
plot_tsm <- create_boxplot(km_df_filtered, env_var = "TSM", dep_var = "bm_g_m3", y_limits = c(0, 0.003))
plot_chla <- create_boxplot(km_df_filtered, env_var = "CHLA", dep_var = "bm_g_m3", y_limits = c(0, 0.003))
plot_cur <- create_boxplot(km_df_filtered, env_var = "CUR", dep_var = "bm_g_m3", y_limits = c(0, 0.003))
plot_sst <- create_boxplot(km_df_filtered, env_var = "SST", dep_var = "bm_g_m3", y_limits = c(0, 0.003))
plot_tmin <- create_boxplot(km_df_filtered, env_var = "Tmin", dep_var = "bm_g_m3", y_limits = c(0, 0.003))
plot_o2_min <- create_boxplot(km_df_filtered, env_var = "O2_min", dep_var = "bm_g_m3", y_limits = c(0, 0.003))
