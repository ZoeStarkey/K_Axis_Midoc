...
plot(gymno_epi_pred, col=viridis(100), zlim=c(0,10), axes=F, main=tit)
...
plot(gymno_meso_pred, col=viridis(100), zlim=c(0,10), axes=F, main=tit)
plot(f3$finished$geometry[1:5], add=T,col="grey",lwd=3,lty=5) #SBdy
plot(bc, add=T)
points(p$lon_start, p$lat_start, cex=1.0, col="red")
degAxis(1)
...
plot(gymno_ubathy_pred, col=viridis(100), zlim=c(0,10), axes=F, main=tit)
plot(f3$finished$geometry[1:5], add=T,col="grey",lwd=3,lty=5) #SBdy
plot(bc, add=T)
points(p$lon_start, p$lat_start, cex=1.0, col="red")
degAxis(1)
