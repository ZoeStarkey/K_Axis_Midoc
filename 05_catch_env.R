...
km$zone <- bz$bestley.zone[match(km$midoc.stn, bz$midoc.stn)]
...
# linear interpolation of Tmin, mixed layer depths based on time
oc$gmt <- ISOdatetime(2016, oc$month, oc$day, 0, 0, 0, tz = "GMT")
km$Tmin <- approxfun(oc$gmt, oc$Tmin_value, rule = 2)(km$start_time)
...
## TODO: going forward; locations of stations 4 and 5 are a bit off...
