...
#km_bm_sum_2 <-  km_bm_sum_2 %>% filter(days_since_melt <500)

#days since melt is unusually high for MIDOC 27, averaging the results from nearby stations 
