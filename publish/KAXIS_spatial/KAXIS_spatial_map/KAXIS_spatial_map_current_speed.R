...
#loading current speed data
load("~/Desktop/Honours/Data_Analysis/K_axis_midoc/publish/KAXIS_spatial/KAXIS_raster/KAXIS_curr_big.RData")
...
current_spatial_plot_all_taxa <- spatial_map_currents(km_bm_sum_2, "bm_sum_all_taxa", decimal_places = 2)
# Fish
