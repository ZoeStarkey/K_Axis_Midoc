...
##two terms
m2.1 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                     s(bathy_s, bs="cs"), family="nb", data=p)
m2.2 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(bath_g_s, bs="cs"), family="nb", data=p)
m2.3 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(sst_s, bs="cs"), family="nb", data=p)
m2.4 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(sstg_s, bs="cs"), family="nb", data=p)
m2.5 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs"), family="nb", data=p)
m2.6 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssha_s, bs="cs"), family="nb", data=p)
m2.7 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(vssha_s, bs="cs"), family="nb", data=p)
m2.8 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(chl_rs_s, bs="cs"), family="nb", data=p)
m2.9 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ice_s, k=4, bs="cs"), family="nb", data=p)
m2.10 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
...
##addtional terms helps help - move on to 3 term model
m3.1 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(bathy_s, bs="cs"),
                    family="nb", data=p)
m3.2 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(bath_g_s, bs="cs"),
                    family="nb", data=p)
m3.3 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(sst_s, bs="cs"),
                    family="nb", data=p)
m3.4 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(sstg_s, bs="cs"),
            family="nb", data=p)
m3.5 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(ssha_s, bs="cs"),
                    family="nb", data=p)
m3.6 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(vssha_s, bs="cs"),
                    family="nb", data=p)
m3.7 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(chl_rs_s, bs="cs"),
                    family="nb", data=p)
m3.8 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(ice_s, k=4, bs="cs"),
                    family="nb", data=p)
m3.9 <- gam(kref_b2~s(days_since_melt_s, bs="cs")+
                    s(ssh_s, bs="cs")+
                    s(dtie_s, bs="cs"),
                    family="nb", data=p)
...
summary(m1.9)$dev.expl
summary(m2.5)$dev.expl
summary(m3.8)$dev.expl

##third term is not helpful - go with 2 term odel
