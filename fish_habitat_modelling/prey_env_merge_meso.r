...
kreff_grp_bm_meso <- readRDS("~/kaxis/fish_habitat_modelling/kreff_grp_bm_meso.RDS")
station_env <- readRDS("~/kaxis/fish_habitat_modelling/station_env.rds")
ele_gymno_grp_bm_meso <- readRDS("~/kaxis/fish_habitat_modelling/ele_gymno_grp_bm_meso.RDS")
bathy_grp_bm_meso <- readRDS("~/kaxis/fish_habitat_modelling/bathy_grp_bm_meso.RDS")
...
prey <- merge(kreff_grp_bm_meso[,c("midoc.stn", "n_m3", "bm_m3")], 
              bathy_grp_bm_meso[,c("midoc.stn", "n_m3", "bm_m3")], 
...
saveRDS(prenv, file="~/kaxis/fish_habitat_modelling/prey_env_meso.rds")
