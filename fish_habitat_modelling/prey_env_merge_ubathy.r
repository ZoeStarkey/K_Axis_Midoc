...
kreff_grp_bm_ubathy <- readRDS("~/kaxis/fish_habitat_modelling/kreff_grp_bm_ubathy.RDS")
station_env <- readRDS("~/kaxis/fish_habitat_modelling/station_env.rds")
ele_gymno_grp_bm_ubathy <- readRDS("~/kaxis/fish_habitat_modelling/ele_gymno_grp_bm_ubathy.RDS")
bathy_grp_bm_ubathy <- readRDS("~/kaxis/fish_habitat_modelling/bathy_grp_bm_ubathy.RDS")
...
prey <- merge(kreff_grp_bm_ubathy[,c("midoc.stn", "n_m3", "bm_m3")], 
              bathy_grp_bm_ubathy[,c("midoc.stn", "n_m3", "bm_m3")], 
              by.x="midoc.stn", by.y="midoc.stn", all.x=T)
prey <- merge(prey, 
              ele_gymno_grp_bm_ubathy[,c("midoc.stn", "n_m3", "bm_m3")], 
              by.x="midoc.stn", by.y="midoc.stn", all.x=T)
...
saveRDS(prenv, file="~/kaxis/fish_habitat_modelling/prey_env_ubathy.rds")
